...
#---- duplicated version (add)
#set_max_delay $long_clk  -through add__inst__acc 
#set_max_delay $clk_period -through add__inst__apx 
#---- duplicated version (mul)
...
#report_timing -sort_by slack -significant_digits 4 >>  ${all_data__file__addr}
# --- duplicated version(Add)
#report_timing -sort_by slack -through [get_object_name [get_pins -of_objects [get_object_name [get_cells -hierarchical -filter "full_name == add__inst__apx"]]  -filter "direction == in"]]  -significant_digits 4 >>  ${all_data__file__addr}
#report_timing -sort_by slack -through [get_object_name [get_pins -of_objects [get_object_name [get_cells -hierarchical -filter "full_name == add__inst__acc"]]  -filter "direction == in"]]  -significant_digits 4 >>  ${all_data__file__addr}
# --- duplicated version(mul)
report_timing -sort_by slack -through [get_object_name [get_pins -of_objects [get_object_name [get_cells -hierarchical -filter "full_name == mul__inst__apx"]]  -filter "direction == in"]]  -significant_digits 4 >>  ${all_data__file__addr}
report_timing -sort_by slack -through [get_object_name [get_pins -of_objects [get_object_name [get_cells -hierarchical -filter "full_name == mul__inst__acc"]]  -filter "direction == in"]]  -significant_digits 4 >>  ${all_data__file__addr}
...
#echo "**************** " >> ${REPORTS_DIR}/data_collected/${all_data__file__addr}
#----------------------------------------------------
#set_max_delay $clk_period  -through [get_object_name [get_pins -of_objects [get_object_name [get_cells -hierarchical -filter "full_name == mul__inst__apx"]]  -filter "direction == in"]] -to [all_outputs]
#set_max_delay $clk_period -through mul__inst__apx  -to [all_outputs] ;#modifying the constraint to makesure
#set_max_delay $clk_period -to [all_outputs]
...
#---acc first
#--- duplicated version (only)
#report_timing -sort_by group -nworst 1000 -significant_digits 4  -through [get_object_name [get_pins -of_objects [get_object_name [get_cells -hierarchical -filter "full_name == add__inst__apx"]]  -filter "direction == in"]] >  ${REPORTS_DIR}/${report_file__prefix}__timing.rpt


#report_timing -sort_by slack -through mul__inst__apx -significant_digits 4 
#--- apx first
...
#report_timing -sort_by slack -through mul__inst__apx -significant_digits 4 >>  ${all_data__file__addr}
#report_timing -sort_by slack -through mul__inst__apx -significant_digits 4 >>  ${all_data__file__addr}
