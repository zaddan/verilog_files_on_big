...
#---duplicated
report_timing -sort_by slack -through [get_object_name [get_pins -of_objects [get_object_name [get_cells -hierarchical -filter "full_name == add__inst__apx"]]  -filter "direction == in"]] -significant_digits 4 > ${REPORTS_DIR}/${report_file__prefix}__timing.rpt
