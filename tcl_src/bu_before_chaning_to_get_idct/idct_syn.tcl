...
#analyze -format verilog [list  ${design_dir_addr}/idct_simple_add.v ${design_dir_addr}/conf_int_mul__noFF__arch_agnos__w_wrapper.v]
analyze -format verilog [list  ${design_dir_addr}/idct_simple_add.v ${design_dir_addr}/conf_int_mul__noFF__arch_agnos__w_wrapper.v]
...
write -f verilog -hierarchy -output ${RTLDIR}/${syn_name}_synthesized.v
